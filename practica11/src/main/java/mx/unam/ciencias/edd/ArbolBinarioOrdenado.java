...
public class ArbolBinarioOrdenado<T extends Comparable<T>>
    ...
    private void comparador(Vertice nuevo, Vertice actual){
      if(nuevo.elemento.compareTo(actual.elemento) <= 0){
        if(actual.izquierdo == null){
          actual.izquierdo = nuevo;
          nuevo.padre = actual;
        } else{
          comparador(nuevo, actual.izquierdo);
        } 
      } else{
        if(actual.derecho == null){
          ...
          comparador(nuevo, actual.derecho);
        }
      } 
    }
    /**
    ...
    protected Vertice intercambiaEliminable(Vertice vertice) {
        // Aquí va su código.
      Vertice maximal = maximoVertice(vertice.izquierdo);
      T elemento = maximal.elemento;
    ...
    protected void eliminaVertice(Vertice vertice) {
      ...
      if(vertice.izquierdo == null && vertice.derecho == null){
        ...
        if(vertice.padre == null){
          ...
          eliminarLinea(vertice.padre, vertice.derecho, vertice);
        }
      } else{
        if(vertice.padre == null){
          ...
          eliminarLinea(vertice.padre, vertice.izquierdo, vertice);
        }
      }
    }
    private void eliminarLinea(Vertice padre, Vertice hijo, Vertice eliminar){
    ...
    private Vertice maximoVertice(Vertice vertice){
      if(vertice.derecho == null) return vertice;
      return maximoVertice(vertice.derecho);
    }
    ...
    @Override public VerticeArbolBinario<T> busca(T elemento) {
        // Aquí va su código.
      return buscador(raiz, elemento);
    }
    private VerticeArbolBinario<T> buscador(Vertice v, T elemento){
      if(v == null) return null;
      if(v.elemento.equals(elemento))
        return v;
      else if(v.elemento.compareTo(elemento) > 0)
        return buscador(v.izquierdo, elemento);
      else
        return buscador(v.derecho, elemento);
    }
    ...
    public void giraDerecha(VerticeArbolBinario<T> vertice) {
      ...
      if(girar.izquierdo == null) return;
    ...
    public void dfsPreOrder(AccionVerticeArbolBinario<T> accion) {
        // Aquí va su código.
        preOrder(accion, raiz);
    }
    private void preOrder(AccionVerticeArbolBinario<T> accion, Vertice vertice){
      if(vertice == null) return;
      accion.actua(vertice);
      preOrder(accion, vertice.izquierdo);
      preOrder(accion, vertice.derecho);
    }
    ...
    private void inOrder(AccionVerticeArbolBinario<T> accion, Vertice vertice){
      if(vertice == null) return;
      inOrder(accion, vertice.izquierdo);
      accion.actua(vertice);
      inOrder(accion, vertice.derecho);
    }
    ...
    public void dfsPostOrder(AccionVerticeArbolBinario<T> accion) {
        // Aquí va su código.
      postOrder(accion, raiz);
    }
    private void postOrder(AccionVerticeArbolBinario<T> accion, Vertice vertice){
      if(vertice == null) return;
      postOrder(accion, vertice.izquierdo);
      postOrder(accion, vertice.derecho);
      accion.actua(vertice);
    }
