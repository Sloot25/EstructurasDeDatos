...
public class Grafica<T> implements Coleccion<T> {
    ...
    public void conecta(T a, T b) throws NoSuchElementException, IllegalArgumentException{
      ...
      ((Vertice)vertice(a)).vecinos.agrega(new Vecino((Vertice)vertice(b),1));
      ((Vertice)vertice(b)).vecinos.agrega(new Vecino((Vertice)vertice(a),1));
      aristas++;
        // Aquí va su código.
    }
    ...
    public void conecta(T a, T b, double peso) {
      ...
      if(sonVecinos(a,b) || a.equals(b) || peso < 0) 
        throw new IllegalArgumentException("los elementos ya estan conectados o son iguales");
      ((Vertice)vertice(a)).vecinos.agrega(new Vecino((Vertice)vertice(b),peso));
      ((Vertice)vertice(b)).vecinos.agrega(new Vecino((Vertice)vertice(a),peso));
      aristas++;
    }
    ...
    public void desconecta(T a, T b) throws IllegalArgumentException {
      ...
      ((Vertice)vertice(a)).vecinos.elimina(buscaVecino((Vertice)vertice(a), b));
      ((Vertice)vertice(b)).vecinos.elimina(buscaVecino((Vertice)vertice(b), a));
      aristas--;
    }
    /**
    ...
    @Override public void elimina(T elemento) throws NoSuchElementException {
        ...
        for(Vecino vecino : eliminar.vecinos){
          vecino.vecino.vecinos.elimina(buscaVecino(vecino.vecino, eliminar.elemento));
          aristas--;
         }
        // Aquí va su código.
    }
    ...
    public boolean sonVecinos(T a, T b) throws NoSuchElementException{
      ...
      return buscaVecino((Vertice)vertice(a) , b) != null && buscaVecino((Vertice)vertice(b), a) != null;
        // Aquí va su código.
    }
    ...
    public double getPeso(T a, T b) throws NoSuchElementException, IllegalArgumentException{
      ...
      if(!sonVecinos(a,b))
        throw new IllegalArgumentException("Los elementos no estan conectados");
      return buscaVecino((Vertice)vertice(a) , b).peso;
    }
    ...
    public void setPeso(T a, T b, double peso) {
      ...
      if(!sonVecinos(a, b) || peso <= 0)
        throw new IllegalArgumentException("Los elementos no estan conectados");
      buscaVecino((Vertice)vertice(a), b).peso = peso;
      buscaVecino((Vertice)vertice(b), a).peso = peso;
    }
    ...
    public Lista<VerticeGrafica<T>> dijkstra(T origen, T destino) {
      ...
      Vertice actual = (Vertice)vertice(origen);
      actual.distancia = 0;
      MonticuloDijkstra<Vertice> monticulo = (((getElementos() - 1)*getElementos()/2) - getElementos() < aristas ) ? new MonticuloArreglo<Vertice>(vertices) : new MonticuloMinimo<Vertice>(vertices);
